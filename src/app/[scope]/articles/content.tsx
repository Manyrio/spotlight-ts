                        ...
                        <div className="relative aspect-[16/9] sm:aspect-[2/1] lg:aspect-square lg:w-64 lg:shrink-0">

                            {
                                article.attributes.image.data ?
                                    <img className="absolute inset-0 h-full w-full rounded-2xl bg-gray-50 object-cover" src={process.env.NEXT_PUBLIC_BACKEND_URL + (article.attributes.image.data.attributes.url)} alt="" />
