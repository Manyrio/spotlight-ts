    ...
    <>
      ...
      <SimpleLayout
        ...
        <div className="-mt-6 flex flex-col gap-16 sm:gap-y-20 lg:flex-row">
          ...
          <div className="mx-auto mt-9 text-base leading-7 gap-8 flex flex-col ">

            {adresses.map((adresse) => (
              <div>
                <h3 className="border-l border-indigo-600 pl-6 font-semibold text-gray-900">{adresse.name}</h3>
